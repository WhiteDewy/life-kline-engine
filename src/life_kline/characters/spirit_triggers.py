...
PLANET_TRIGGERS: dict[str, PlanetTrigger] = {
    ...
    "SATURN": PlanetTrigger("土星", ["我知道这件事压在你心上。", "你已经承担了不少，我听见了。", "这确实不轻松，我们稳一点来看。"], ["压力", "责任", "困难", "坚持", "规则", "边界", "时间"], ["长期课题", "责任边界", "成熟路径", "稳定能力"], 1, "土星认真地提醒你：{suggestion}", ["先把今天真正需要承担的部分留下，其余的放一放。", "慢并不等于停下，你可以按自己的节奏来。"]),
    ...
    "NEPTUNE": PlanetTrigger("海王星", ["我感受到你话里那份说不清的心情。", "有些感受不需要马上说清，我陪你待一会儿。", "你心里那层雾，我看见了。"], ["梦想", "直觉", "疗愈", "迷茫", "想象", "逃避", "灵感"], ["直觉讯息", "梦想边界", "疗愈方式", "灵感来源"], 1, "海王星想轻声告诉你：{suggestion}", ["暂时没有答案也没关系，先听听身体和感受。", "让情绪沉一沉，真实的需要会慢慢浮出来。"]),
    "PLUTO": PlanetTrigger("冥王星", ["我听见这件事触到了你很深的地方。", "你愿意谈到这里，并不容易。", "这份沉重我不会轻轻带过。"], ["失去", "控制", "创伤", "重生", "秘密", "执念", "转变"], ["深层恐惧", "控制模式", "转化力量", "告别与重生"], 1, "冥王星想认真告诉你：{suggestion}", ["不用逼自己立刻放下，先承认它对你的影响。", "你可以只靠近真相一点点，不必一次走到底。"]),
}
